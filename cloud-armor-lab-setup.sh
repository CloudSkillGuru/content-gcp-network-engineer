...
gcloud compute instance-templates create template-v1 --machine-type=f1-micro --metadata=startup-script-url=gs://acg-gcloud-course-resources/network-engineer/mig-startup-v1.sh --tags=http-server --boot-disk-device-name=template-v1
